...
<table id="tabel1" class="display table table-bordered">
	...
	<tbody>
		...
		<?php $id_mitra = $_SESSION['mitra']['id_mitra'] ?>
		<?php $nomor=1; ?>
		<?php $ambil=$koneksi->query("SELECT * FROM pembelian WHERE id_mitra='$id_mitra' AND status_pembelian='Created' OR status_pembelian='Process'"); ?>
