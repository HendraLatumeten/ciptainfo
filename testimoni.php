...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>GG STORE | Toko Gaming Online telengkap dan terpercaya di Tangerang</title> 
	<meta name="description" content="gaming, tangerang, terlengkap, information, technology, jababeka, baru, murah"/>
	<meta name="keywords" content="perlengkapan, Murah, tangerang, Baru, terlengkap, harga, terjangkau" />
	<meta name="author" content="kanzen"/>
	<!-- end: Meta -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="#"><img src="img/logo2.jpg" alt="Logo"></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<h3>Tentang GG STORE</h3>
					<p>
						GG STORE adalah toko gaming online yang bergerak di bidang komputer, sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
				...
				<div class="span3">
					...
					<h3>Alamat Kami</h3>
					Jl Raya No.1 Rt.01 Rw.02 Kecamatan Pamulang Kota Tangerang Selatan 15417<br />
                    Telp : 081234567890<br />
                    Email : <a href="mailto:ggolstore@gmail.com">ggolstore@gmail.com</a>
				</div>
				<!-- end: Photo Stream -->
