...
<form method="POST" enctype="multipart/form-data">
	...
	<div class="form-grup">
		...
		<input type="number" class="form-control" name="harga_utama" required="">
	</div>
	<div class="form-grup">
...
<?php
	if (isset($_POST['simpan'])) {
		...
		} elseif ($_POST['harga_utama']=="") {
			echo "<script>alert('harap isi harga utama');</script>";
		} elseif ($_POST['harga_partisi']=="") {
			echo "<script>alert('harap isi harga partisi');</script>";

		} else {
			$koneksi->query("INSERT INTO data_kayu (nama_kayu,harga_utama,harga_partisi,satuan,stok) VALUES ('$_POST[nama]','$_POST[harga_utama]','$_POST[harga_partisi]','$_POST[satuan]','$_POST[stok]')");
