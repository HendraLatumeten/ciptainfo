                ...
                <form id="msform">
                    ...
                    <div class="container">
                        <div class="form-card" style="margin-right:20px;">
                            <div class="row">
                                <div class="col-5">
                                    <h2 class="fs-title">Survei</h2>
                                </div>
                                <div class="col-5">
                                    <h2 class="steps">Surve1</h2>
                                </div>
                            </div> 
                                <p></p>
                        </div>
                    ...
                    <input type="button" id="step" class="next action-button" onclick="step1()" style="margin-right:20px;"/>
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <input type="button" id="step2" class="next action-button"/>
